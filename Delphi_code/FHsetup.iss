...
DefaultDirName={pf}\FengShuiPro
DefaultGroupName=FengShui professional
AllowNoIcons=yes
...
[Icons]
Name: "{group}\FengShui 4.0"; Filename: "{app}\FengShui.exe"
Name: "{group}\Справка по FengShui 4.0"; Filename: "{app}\help\index.htm"
Name: "{group}\FengShui в Интернет"; Filename: "{app}\FengShui.url"
Name: "{userdesktop}\FengShui 4.0"; Filename: "{app}\FengShui.exe"; MinVersion: 4,4; Tasks: desktopicon
...
[Run]
Filename: "{app}\FengShui.exe"; Description: "Запустить программу FengShui 4.0 сейчас"; Flags: nowait postinstall skipifsilent
