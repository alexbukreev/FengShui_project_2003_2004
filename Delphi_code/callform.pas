...
begin
  ...
  LabelYearBegin.Caption:='Год китайского календаря:';
  LabelJuang.Caption:='Юань (60 лет):';
  LabelJung.Caption:='Большой юнь (60 лет):';
  Label1.Caption:='Малый юнь (20 лет):';
  YearStar.Caption:='Звезда года:';
  MoonStar.Caption:='Звезда месяца:';
  LabelDayStar.Caption:='Звезда дня:';
  LabelChasStar.Caption:='Звезда часа:';
  MoonMLabel.Caption:='Лунный месяц:';
  MoonDLabel.Caption:='Лунный день:';
  LabelStarLeap.Caption:='(дополнительный)';
