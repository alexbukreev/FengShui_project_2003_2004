...
begin
RadioGroup3.Caption:='Характер комбинаций: ';
Label1.Caption:='Звезда хозяин:';
Label2.Caption:='Звезда гость:';
Caption:='Комбинации звезд';
Button1.Caption:='Описание комбинации';
RadioGroup1.Items.Strings[0]:='1 белая';
RadioGroup1.Items.Strings[1]:='2 черная';
RadioGroup1.Items.Strings[2]:='3 бирюзовая';
RadioGroup1.Items.Strings[3]:='4 зеленая';
RadioGroup1.Items.Strings[4]:='5 желтая';
RadioGroup1.Items.Strings[5]:='6 белая';
RadioGroup1.Items.Strings[6]:='7 алая';
RadioGroup1.Items.Strings[7]:='8 белая';
RadioGroup1.Items.Strings[8]:='9 пурпурная';
RadioGroup2.Items.Strings[0]:='1 белая';
RadioGroup2.Items.Strings[1]:='2 черная';
RadioGroup2.Items.Strings[2]:='3 бирюзовая';
RadioGroup2.Items.Strings[3]:='4 зеленая';
RadioGroup2.Items.Strings[4]:='5 желтая';
RadioGroup2.Items.Strings[5]:='6 белая';
RadioGroup2.Items.Strings[6]:='7 алая';
RadioGroup2.Items.Strings[7]:='8 белая';
RadioGroup2.Items.Strings[8]:='9 пурпурная';
